# -*- coding: utf-8 -*-
#
# sitelle documentation build configuration file, created by
...
project = u'sitelle'
copyright = u'2018, Barthélémy Launet'
author = u'Barthélémy Launet'
...
latex_documents = [
    (master_doc, 'sitelle.tex', u'sitelle Documentation',
     u'Barthélémy Launet', 'manual'),
]
...
man_pages = [
    (master_doc, 'sitelle', u'sitelle Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'sitelle', u'sitelle Documentation',
     author, 'sitelle', 'One line description of project.',
     'Miscellaneous'),
]
