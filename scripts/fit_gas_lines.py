...
cube_binned = io.read_fits('../fits/wavenumber_rebinned/M31_SN3_rebinned_48x48_sky_clean.fits')
...
#    print res.shape
np.save('gas_after_sky_lines_fit.npy', line_spectra)
np.save('gas_after_sky_lines_param.npy', fit_params)
