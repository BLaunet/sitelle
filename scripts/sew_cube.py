...
def sew(files_dir, type, out_prefix, on_rebinned=True):
    if type == 'CUBE':
        hdu2 = fits.open(files_dir+'M31_SN2_rebinned_48_cube.fits')[0]
        hdu3 = fits.open(files_dir+'M31_SN3_rebinned_48_cube.fits')[0]
        #hdu2 = fits.open(files_dir+'M31_SN2_wl_grid_bandpass.fits')[0]
        #hdu3 = fits.open(files_dir+'M31_SN3_wl_grid_bandpass.fits')[0]
    elif type == 'FWHM':
        hdu2 = fits.open(files_dir+'M31_SN2_rebinned_48_fwhm.fits')[0]
        hdu3 = fits.open(files_dir+'M31_SN3_rebinned_48_fwhm.fits')[0]
    ...
    if on_rebinned:
        SN2_wl_grid = SN2_wl_grid.T
        SN3_wl_grid = SN3_wl_grid.T
